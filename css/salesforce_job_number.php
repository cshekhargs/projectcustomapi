...
<form action="http://" name="EnfocusConnectMetadata" enctype="application/x-wwwform-urlencoded">
  ...
  <div class="titleMainsales textfldBox" style="margin-bottom: 10px;"><span>Your Project Specifications:</span></div>
         
		  <div id="MF_1" class="textfldBox">
         ...
         <div id="MF_4" class="textfldBox">
            <label for="InsidePageCount" title="" class="titleLab">Page Count</label><br>
		 ...
		 <?php if($testOpp['Prepress_Binding_Type__c'] = 'Case (Hardcover) with Dust Jacket' && $testOpp['Prepress_Binding_Type__c'] = 'Case (Hardcover)' && $testOpp['Prepress_Binding_Type__c'] = '') { ?>
		  <div id="MF_5" class="textfldBox">
         ...
         <div id="MF_6" class="textfldBox">
            <label for="PrintingColor" title="" class="titleLab">Printing Color</label><br>
            <input class="textbox" value="<?php echo $testOpp['PRN_printingcolor__c']; ?>" name="PrintingColor" id="PrintingColor" readonly="" type="text">
         </div>
		 
		  <div id="MF_8" class="textfldBox">
		  ...
		  <?php if($testOpp['Specialty_Options_Book__c'] = '' && $testOpp['Specialty_Options_Book__c'] = 0) { ?>
		  <div id="MF_10" class="textfldBox">
            <label for="SpecialtyOptions" title="" class="titleLab">Specialty Options</label><br>
            <input class="textbox" value="<?php echo $testOpp['Specialty_Options_Book__c']; ?>" name="SpecialtyOptions" id="SpecialtyOptions" readonly="" type="text">
         </div>
		 <?php } ?>
		 
		 <?php if($testOpp['PRN_variantcovers__c'] = '' && $testOpp['PRN_variantcovers__c'] = 0) { ?>
		 <div id="MF_11" class="textfldBox">
            <label for="VariantCovers" title="" class="titleLab">Variant Covers</label><br>
            <input class="textbox" value="<?php echo $testOpp['PRN_variantcovers__c']; ?>" name="VariantCovers" id="VariantCovers" readonly="" type="text">
         </div>
		 <?php } ?>
		 
		 <!-- Hidden fields -->
         <input type="hidden" name="SpotColors" id="SpotColors" value="<?php echo $testOpp['Prepress_Spot_Colors__c']; ?>"/>
		 <input type="hidden" name="CoverPageCount" id="CoverPageCount" value="<?php echo $testOpp['Prepress_Cover_Pages__c']; ?>"/>
		 <input type="hidden" name="CoverSpineWidth" id="CoverSpineWidth" value="<?php echo $testOpp['PrePress_Spine__c']; ?>"/>
		 <input type="hidden" name="FrenchFoldFlapWidth" id="FrenchFoldFlapWidth" value="<?php echo $testOpp['Prepress_French_Fold_Flap_Width__c']; ?>"/>
		 <input type="hidden" name="CoverMediaBoxWidth" id="CoverMediaBoxWidth" value="<?php echo $testOpp['Prepress_Cover_Media_Box_Width__c']; ?>"/>
		 <input type="hidden" name="CoverMediaBoxHeight" id="CoverMediaBoxHeight" value="<?php echo $testOpp['Prepress_Cover_Media_Box_Height__c']; ?>"/>
		 <input type="hidden" name="CoverDieLineWidth" id="CoverDieLineWidth" value="<?php echo $testOpp['Prepress_Cover_Die_Line_Width__c']; ?>"/>
		 <input type="hidden" name="CoverDieLineHeight" id="CoverDieLineHeight" value="<?php echo $testOpp['Prepress_Cover_Die_Line_Height__c']; ?>"/>
		 <input type="hidden" name="CoverHingeWidth" id="CoverHingeWidth" value="<?php echo $testOpp['Prepress_Hinge_Width__c']; ?>"/>
		 <input type="hidden" name="DustJacketPageCount" id="DustJacketPageCount" value="<?php echo $testOpp['Prepress_Dust_Jacket_Pages__c']; ?>"/>
		 <input type="hidden" name="DustJacketSpineWidth" id="DustJacketSpineWidth" value="<?php echo $testOpp['Prepress_Dust_Jacket_Spine__c']; ?>"/>
		 <input type="hidden" name="DustJacketFlapWidth" id="DustJacketFlapWidth" value="<?php echo $testOpp['PrePress_Dust_Jacket_Flap_Width__c']; ?>"/>
		 <input type="hidden" name="DustJacketMediaBoxWidth" id="DustJacketMediaBoxWidth" value="<?php echo $testOpp['Prepress_Dust_Jacket_Media_Box_Width__c']; ?>"/>
		 <input type="hidden" name="DustJacketMediaBoxHeight" id="DustJacketMediaBoxHeight" value="<?php echo $testOpp['Prepress_Dust_Jacket_Media_Box_Height__c']; ?>"/>
		 <input type="hidden" name="DustJacketDieLineWidth" id="DustJacketDieLineWidth" value="<?php echo $testOpp['Prepress_Dust_Jacket_Die_Line_Width__c']; ?>"/>
		 <input type="hidden" name="DustJacketDieLineHeight" id="DustJacketDieLineHeight" value="<?php echo $testOpp['Prepress_Dust_Jacket_Die_Line_Height__c']; ?>"/>
		 <input type="hidden" name="DustJacketFlapDieLine" id="DustJacketFlapDieLine" value="<?php echo $testOpp['Prepress_Dust_Jacket_Flap_Die_Line__c']; ?>"/>
		 <input type="hidden" name="TotalPages" id="TotalPages" value="<?php echo $testOpp['Prepress_Total_Pages__c']; ?>"/>
		 <input type="hidden" name="TotalSpreads" id="TotalSpreads" value="<?php echo $testOpp['Prepress_Total_Spreads__c']; ?>"/>
		 <input type="hidden" name="MediaBoxWidth" id="MediaBoxWidth" value="<?php echo $testOpp['MediaBox_Width__c']; ?>"/>
		 <input type="hidden" name="MediaBoxHeight" id="MediaBoxHeight" value="<?php echo $testOpp['MediaBox_Height__c']; ?>"/>
		 <input type="hidden" name="SpreadMediaBoxWidth" id="SpreadMediaBoxWidth" value="<?php echo $testOpp['Spread_Width__c']; ?>" />
		 <input type="hidden" name="SpreadMediaBoxHeight" id="SpreadMediaBoxHeight" value="<?php echo $testOpp['MediaBox_Spread_Height__c']; ?>" />
		 <input type="hidden" name="FirstLastMediaBoxWidth" id="FirstLastMediaBoxWidth" value="<?php echo $testOpp['Prepress_Media_Box_Width_First_Last__c']; ?>" />
         <input type="hidden" name="FirstLastMediaBoxHeight" id="FirstLastMediaBoxHeight" value="<?php echo $testOpp['Prepress_Media_Box_Height_First_Last__c']; ?>" />
		 <input type="hidden" name="OrderedISBN" id="OrderedISBN" value="<?php echo $testOpp['Ordered_ISBN__c']; ?>" />		 
         <!-- Hidden Fields EDO -->		 
		 
		 
         <div id="MF_7" class="subbtnCont" style="margin: 17px 0px 65px 65px;">
